...
title: "文章标题"
subtitle: "文章副标题"
date: 2026-02-23T19:36:15+08:00
draft: true
description: "文章描述"
comment: true
weight: 0
...
```c {mode="simple", maxShownLines=5}
mode="mac" classic simple
...
```c {mode="mac", linenos=true, hl_lines="2-3"}
int main() {
    printf("Hello, World!");
    return 0;
}
{mode="mac", linenos=true, hl_lines="2-3"}
```
...
{{< image src="/images/image.webp" caption="图片描述" >}}
