...
<div style="text-align: center; margin: 30px 0;">
  <a href="https://www.rainyun.com/NjQ4NjU3_?s=blog-hexo" target="_blank" style="--width: 180px; --height: 50px; --tooltip-height: 35px; --tooltip-width: 120px; --gap-between-tooltip-to-button: 18px; --button-color: #1163ff; --tooltip-color: #fff; width: var(--width); height: var(--height); background: var(--button-color); position: relative; text-align: center; border-radius: 0.45em; transition: background 0.3s; text-decoration: none; display: inline-block; margin: 10px; line-height: 50px; color: #fff; font-weight: bold; font-size: 1rem;">
    立即注册领取
  </a>
</div>

![在雨云官网首页点击注册](https://img.san3.cn/img/ebe9a8b774e01d84.webp)

## 2️⃣注册
然后选择下面三个任意一个方法注册都可以
推荐使用微信注册更方便
![微信注册](https://img.san3.cn/img/ac94838b52838e4d.webp)

## 3️⃣做任务赚积分
注册成功后点击 积分中心-»赚取积分
![注册成功后点击积分中心赚取积分](https://img.san3.cn/img/ed608557c06729a2.webp)
新手做任务保底可以领取8500积分，后续每天签到每天可以领取500积分
任务都挺简单的基本都是完善信息
![做任务赚积分](https://img.san3.cn/img/ed608557c06729a2.webp)

## 4️⃣领取服务器
领取积分后点击 积分中心-»积分商城 上面两个都是免费的游戏云服务器
![领取服务器](https://img.san3.cn/img/b7f505d92493a2f6.webp)
...
![应用云](https://img.san3.cn/img/0bab35007f9ebc1e.webp)